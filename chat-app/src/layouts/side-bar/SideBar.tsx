...
type SideBarProps = {
    refreshSession: number; sessionId?: string;
};
...
export const SideBar = ({refreshSession, sessionId}: SideBarProps) => {
    ...
    }, [word, isLogin, refreshSession]);

    return (<div className="sidebar-container flex flex-col h-full bg-white">
        ...
        <div className="border-t border-gray-100 px-3 py-3">
            ...
            </div>) : (<button className="w-full py-2.5 text-sm font-semibold text-white
