...
export const Header = ({
    ...
    return (
        <header className="flex items-center justify-between bg-white px-5 py-3 shadow-sm border-b border-gray-100">
            ...
            {/* Notification */}
            <button
                className="relative group flex h-12 w-12 items-center justify-center rounded-xl border border-gray-200 bg-white text-[#9A001F] shadow-sm transition-all duration-300 hover:bg-[#9A001F] hover:text-white hover:shadow-lg">
                {/* Ping */}
